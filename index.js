...
var mergeInitialDigitSentences = require('parse-latin/lib/plugin/merge-initial-digit-sentences')
var mergeAffixExceptions = require('parse-latin/lib/plugin/merge-affix-exceptions')
var mergeRemainingFullStops = require('parse-latin/lib/plugin/merge-remaining-full-stops')
var makeInitialWhiteSpaceSiblings = require('parse-latin/lib/plugin/make-initial-white-space-siblings')
var makeFinalWhiteSpaceSiblings = require('parse-latin/lib/plugin/make-final-white-space-siblings')
var breakImplicitSentences = require('parse-latin/lib/plugin/break-implicit-sentences')
var removeEmptyNodes = require('parse-latin/lib/plugin/remove-empty-nodes')
var patchPosition = require('parse-latin/lib/plugin/patch-position')
